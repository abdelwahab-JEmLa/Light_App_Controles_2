package com.example.light_app_controles.B.Screens.Z.Screens.Test.ID1.Client_Map.App.Bon_Vent_Etate.View.ID1.FeatureID1_BigDataBase_Editeur_Par_Csv_Floating_Separated_Button.Feature.Options.M2Client_Operations_FragMap_DropdownMenu.Actions
...
import com.example.light_app_controles.B.Screens.Z.Screens.Test.ID1.Client_Map.App.Bon_Vent_Etate.View.ID1.FeatureID1_BigDataBase_Editeur_Par_Csv_Floating_Separated_Button.Feature.Options.M2Client_Operations_FragMap_DropdownMenu.Actions.Action.But6_Import_M2_FireBase_To_Csv
import com.example.light_app_controles.B.Screens.Z.Screens.Test.ID1.Client_Map.App.Bon_Vent_Etate.View.ID1.FeatureID1_BigDataBase_Editeur_Par_Csv_Floating_Separated_Button.Feature.Options.M2Client_Operations_FragMap_DropdownMenu.Actions.Action.But8_DeleteAll_M2_Room
import com.example.light_app_controles.B.Screens.Z.Screens.Test.ID1.Client_Map.App.Bon_Vent_Etate.View.ID1.FeatureID1_BigDataBase_Editeur_Par_Csv_Floating_Separated_Button.Feature.Options.M2Client_Operations_FragMap_DropdownMenu.Actions.Action.But9_Import_M2_FireBase_To_Room
...
enum class PendingAction(
    ...
    But1_Export_M2_Room_To_Csv,
    But2_Export_M2_Csv_To_FireBase,
    But3_Import_M2Csv_To_Room,
    But5_Import_M2_Ui_To_Room,
    But6_Import_M2_FireBase_To_Csv,
    But_9_Import_M2_FireBase_To_Room(Color(0xFFE91E63), Icons.Default.LocalFireDepartment),
    But7_DeleteImport_M2Csv_To_Room,
    But8_DeleteAll_M2_Room, ;
}
...
fun M2Client_Operations_FragMap_DropdownMenu(
        ...
        withContext(Dispatchers.IO) {
            ...
            if (csv.exists() && csv.length() > 0L) {
                ...
                if (lines.size >= 2) {
                    ...
                    val roomKeys = vm.active_Datas.list_M2Client
    ...
    pendingAction?.let { action ->
        when (action) {
            PendingAction.But8_DeleteAll_M2_Room -> But8_DeleteAll_M2_Room(
                vm = vm,
                coroutineScope = coroutineScope,
                onDismiss = onDismiss,
                onPendingClear = { pendingAction = null },
                action_definition = PendingAction.But8_DeleteAll_M2_Room,
            )

            PendingAction.But3_Import_M2Csv_To_Room -> But3_Import_M2Csv_To_Room(
                vm = vm,
                coroutineScope = coroutineScope,
                onDismiss = onDismiss,
                onPendingClear = { pendingAction = null },
                action_definition = PendingAction.But3_Import_M2Csv_To_Room,
            )

            PendingAction.But2_Export_M2_Csv_To_FireBase -> But2_Export_M2_Csv_To_FireBase(
                vm = vm,
                coroutineScope = coroutineScope,
                onDismiss = onDismiss,
                onPendingClear = { pendingAction = null },
                action_definition = PendingAction.But2_Export_M2_Csv_To_FireBase,
            )

            PendingAction.But1_Export_M2_Room_To_Csv -> But1_Export_M2_Room_To_Csv(
                vm = vm,
                coroutineScope = coroutineScope,
                onDismiss = onDismiss,
                onPendingClear = { pendingAction = null },
                onCsvWritten = { csvRefreshTrigger++ },
                action_definition = PendingAction.But1_Export_M2_Room_To_Csv,
            )

            PendingAction.But6_Import_M2_FireBase_To_Csv -> But6_Import_M2_FireBase_To_Csv(
                vm = vm,
                coroutineScope = coroutineScope,
                onDismiss = onDismiss,
                onPendingClear = { pendingAction = null },
                onCsvWritten = { csvRefreshTrigger++ },
                action_definition = PendingAction.But6_Import_M2_FireBase_To_Csv,
            )

            PendingAction.But5_Import_M2_Ui_To_Room -> {
                AvertissementDialog(
                    title = action.name,
                    message = "سيتم حفظ بيانات M2Client من الواجهة إلى قاعدة البيانات المحلية.\n" +
            ...
            PendingAction.But7_DeleteImport_M2Csv_To_Room -> {
                AvertissementDialog(
                    title = action.name,
                    message =
                        "هل تريد المتابعة؟",
            ...
            PendingAction.But_9_Import_M2_FireBase_To_Room -> But9_Import_M2_FireBase_To_Room(
                vm = vm,
                coroutineScope = coroutineScope,
                onDismiss = onDismiss,
                onPendingClear = { pendingAction = null },
                action_definition = PendingAction.But_9_Import_M2_FireBase_To_Room,
            )
    ...
    DropdownMenu(
        ...
        HorizontalDivider()
        Text("FireBase")
        val action = PendingAction.But_9_Import_M2_FireBase_To_Room
        DropdownMenuItem(
            leadingIcon = {
                Icon(
        ...
        DropdownMenuItem(
            ...
            text = {
                Text(
                    text = PendingAction.But2_Export_M2_Csv_To_FireBase.name,
                    style = MaterialTheme.typography.bodyMedium,
                )
            },
            onClick = {
                pendingAction = PendingAction.But2_Export_M2_Csv_To_FireBase
            }
        )
        DropdownMenuItem(
            leadingIcon = {
            ...
            text = {
                ...
                Column {
                    Text(
                        text = PendingAction.But6_Import_M2_FireBase_To_Csv.name,
                        style = MaterialTheme.typography.bodyMedium,
                    )
                    Text(
                        text = fbStatsLine,
            ...
            onClick = {
                pendingAction = PendingAction.But6_Import_M2_FireBase_To_Csv
            }
        )
        HorizontalDivider(thickness = 3.dp, color = Color.Red)
        DropdownMenuItem(
            ...
            text = {
                Text(
                    text = "But1_Export_M2_Room_To_Csv",
                    style = MaterialTheme.typography.bodyMedium,
                )
            },
            onClick = {
                pendingAction = PendingAction.But1_Export_M2_Room_To_Csv
            }
        )
        ...
        DropdownMenuItem(
            ...
            text = {
                ...
                Column {
                    Text(
                        text = PendingAction.But7_DeleteImport_M2Csv_To_Room.name,
                        style = MaterialTheme.typography.bodyMedium,
                    )
                    Text(
                        text = statsLine,
            ...
            onClick = {
                pendingAction = PendingAction.But7_DeleteImport_M2Csv_To_Room
            }
        )
        HorizontalDivider()
        DropdownMenuItem(
            ...
            text = {
                Text(
                    text = PendingAction.But8_DeleteAll_M2_Room.name,
                    style = MaterialTheme.typography.bodyMedium,
                )
            },
            onClick = {
                pendingAction = PendingAction.But8_DeleteAll_M2_Room
            }
        )
        DropdownMenuItem(
            leadingIcon = {
            ...
            text = {
                Text(
                    text = PendingAction.But3_Import_M2Csv_To_Room.name,
                    style = MaterialTheme.typography.bodyMedium,
                )
            },
            onClick = {
                pendingAction = PendingAction.But3_Import_M2Csv_To_Room
            }
        )
        HorizontalDivider()
        ...
        DropdownMenuItem(
            ...
            text = {
                Text(
                    text = PendingAction.But5_Import_M2_Ui_To_Room.name,
                    style = MaterialTheme.typography.bodyMedium,
                )
            },
            onClick = {
                pendingAction = PendingAction.But5_Import_M2_Ui_To_Room
            }
        )
