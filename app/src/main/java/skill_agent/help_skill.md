...
| **Fix TODOs** (`t_.md`) | `t_`, `t_models`, `fix_todo` | Résout automatiquement les TODOs ou délègue aux skills correspondants (ex: `TODO: log_`, `TODO: sem_`, `TODO: con_c`), puis affiche le diff de code à la fin. |
