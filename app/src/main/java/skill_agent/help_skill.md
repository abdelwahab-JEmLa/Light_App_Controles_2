...
| **Schedule App Launch & Tap Replay** (`tap/Schedule_agy_task_tap_l.md`) | `Schedule_agy_task_tap_l`, `schedule_tap_l`, `sch_tap_l`, `arrete_sch` | Attend que l'app se lance depuis Android Studio pour exécuter tap_l, ou annule l'attente en cours (arrete_sch). |
