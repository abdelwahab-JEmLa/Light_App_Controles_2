...
| **View Desktop Image**             | [`scr_.md`](file:///C:/Users/Abou%20Mohamed/AndroidStudioProjects/Light_App_Controles/app/src/main/java/skill_agent_pc/scr_.md)                             | `scr_<name>`, `scr_<number>`, `image_<name>`                                                               | Trouve une image spécifique ou un numéro (ex: `scr_2` pour `2.jpg` ou `image_2`) sur le Bureau, l'ouvre et en fait l'analyse. |
...
* 🖼️ [View Desktop Image (scr_)](file:///C:/Users/Abou%20Mohamed/AndroidStudioProjects/Light_App_Controles/app/src/main/java/skill_agent_pc/scr_.md)
