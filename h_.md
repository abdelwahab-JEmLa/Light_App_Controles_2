...
| **Fix TODOs and Launch** | `t_`, `fix_todo` | Résout automatiquement les TODOs dans le code, compile et lance l'application (`l_r`), puis affiche le diff du code modifié à la fin. | [t_.md](file:///C:/Users/Abou%20Mohamed/.gemini/antigravity-cli/skills/t_.md) |
